...
public class ItemParser {
    ...
    public Item parseSingleItem(String singleItem) throws ItemParseException, IllegalArgumentException {
    ...
    public Double matchPrice(String price) throws IllegalArgumentException {
